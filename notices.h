...
// Server-wide user leaving messaeg
...
static const int name_request_msg_len = sizeof(name_request_msg);
...
static const int server_join_msg_len = sizeof(server_join_msg);
